    ...
    <div className="result-section px-5" id="result">
      <div className="result-folder ">
        <div className="result-wrapper">
          <h2
            className="font-c text-2xl lg:text-4xl mb-10 m-auto text-center"
            data-aos="fade-down"
          >
            Q: When will I feel results?
          </h2>
          <p
            className="font-c text-base lg:text-lg mb-5 m-auto text-start"
            data-aos="fade-right"
          >
          ...
          <p
            className="font-c text-base lg:text-lg m-auto text-start"
            data-aos="fade-left"
          >
        ...
        <h2
          className="font-c result-question text-2xl lg:text-4xl m-auto "
          data-aos="fade-down"
        >
        ...
        <div className="result-wrap">
          <p
            className="font-c text-base lg:text-lg text-start m-auto mb-5"
            data-aos="fade-right"
          >
            A: We’re glad you asked!
          </p>
          <p
            className="font-c text-base lg:text-lg text-start m-auto mb-4"
            data-aos="fade-left"
          >
          ...
          <p
            className="font-c text-base lg:text-lg text-start m-auto mb-3"
            data-aos="fade-left"
          >
          ...
          <p
            className="font-c text-base lg:text-lg text-start m-auto"
            data-aos="fade-right"
          >
