    ...
    <div className="result-section">
      <div className="result-folder ">
        <div className="result-wrapper">
          <h2 className="font-c text-4xl mb-10 m-auto text-center">
            Q: When will I feel results?
          </h2>
          <p className="font-c text-lg mb-5 m-auto text-start">
            A: Most people can tell if Plato is right for them with their first
            few servings.
          </p>
          <p className="font-c text-lg m-auto text-start">
            That’s why we’re happy to send you a sample so you can feel the
            Plato effect instead of us just telling you about it.
          </p>
        </div>
        <h2 className="font-c result-question text-4xl m-auto ">
          Q: You make some big claims. How can I believe it?
        </h2>
        <div className="result-wrap">
          <p className="font-c text-lg text-start m-auto mb-5">
            A: We’re glad you asked!
          </p>
          <p className="font-c text-lg text-start m-auto mb-4">
          ...
          <p className="font-c text-lg text-start m-auto mb-3">
            You can do your own research by clicking through here to see the
            studies Plato is based on.
          </p>
          <p className="font-c text-lg text-start m-auto">
